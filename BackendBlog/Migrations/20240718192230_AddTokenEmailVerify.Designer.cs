...
namespace BackendBlog.Migrations
{
    ...
    [Migration("20240718192230_AddTokenEmailVerify")]
    partial class AddTokenEmailVerify
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BackendBlog.Model.TokenVerifyEmail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BackendBlog.Model.TokenVerifyEmail", b =>
                {
                    b.HasOne("BackendBlog.Model.User", "User")
                        ...
                        .HasForeignKey("BackendBlog.Model.TokenVerifyEmail", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
